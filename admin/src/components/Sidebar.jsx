...
const Sidebar = ({ setToken }) => {
  ...
  return (
    <div className='admin-sidebar w-[18%] h-screen sticky top-0 self-start'>
      <div className='flex h-screen flex-col px-[12%] py-2 text-[15px]'>
        <div className='mb-2'>
          <div className='p-3 flex flex-col items-start gap-2'>
            <img className=' dark:invert' src={assets.logo} alt='Forever Admin' />
            <div>
              <p className='text-base font-semibold text-gray-800 dark:text-gray-100'>Admin</p>
